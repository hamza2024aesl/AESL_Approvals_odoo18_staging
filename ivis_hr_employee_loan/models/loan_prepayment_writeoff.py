...
class PrepaymentWriteoff(models.Model):
    ...
    #        'recompute_prepayment': fields.boolean('Recompute',readonly=False, help='Tick if you want to upDate the gross value of prepayment and recompute the depreciation with new gross value.'),

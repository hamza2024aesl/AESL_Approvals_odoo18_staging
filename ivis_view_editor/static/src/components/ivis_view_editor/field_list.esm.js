...
FieldListItem.template = "ivis_view_editor.FieldListItem";
FieldListItem.props = {
    field: Object,
    delete: Function,
...
JoinListItem.template = "ivis_view_editor.JoinListItem";
JoinListItem.props = {
    field: Object,
    readonly: Boolean,
};
...
FieldListFieldContextMenu.template = "ivis_view_editor.FieldList.FieldContextMenu";

class FieldListJoinContextMenu extends FieldListContextMenu {}
FieldListJoinContextMenu.template = "ivis_view_editor.FieldList.JoinContextMenu";
...
FieldList.template = "ivis_view_editor.FieldList";

...
class Base(models.AbstractModel):
    ...
    def with_delay(
        ...
        :rtype: :class:`odoo.addons.ivis_import_async.job.DelayableRecordset`
        """
    ...
    def delayable(
        ...
        :module:`~odoo.addons.ivis_import_async.delay`.
        ...
        :rtype: :class:`odoo.addons.ivis_import_async.job.Delayable`
        """
        return Delayable(
            self,
            priority=priority,
    ...
    def _job_store_values(self, job):
        ...
        :param job: current ivis_import_async.job.Job instance.

...
def group(*delayables):
    ...
    Shortcut to :class:`~odoo.addons.ivis_import_async.delay.DelayableGroup`.
...
def chain(*delayables):
    ...
    Shortcut to :class:`~odoo.addons.ivis_import_async.delay.DelayableChain`.
...
class DelayableGraph(Graph):
    ...
    def _has_to_execute_directly(self, vertices):
        ...
        :func:`odoo.addons.ivis_import_async.tests.common.trap_jobs`.
        """
...
class Delayable:
    ...
    by :meth:`~odoo.addons.ivis_import_async.models.base.Base.delayable`. Look
...
class DelayableRecordset:
    ...
    This class will generally not be used directly, it is used internally
    by :meth:`~odoo.addons.ivis_import_async.models.base.Base.with_delay`
    """

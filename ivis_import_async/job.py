...
def DelayableRecordset(*args, **kwargs):
    ...
    _logger.debug(
        "DelayableRecordset moved from the ivis_import_async.job"
        " to the ivis_import_async.delay python module"
    )
...
def identity_exact(job_):
    ...
    .. python::
        ...
        from odoo.addons.ivis_import_async.job import identity_exact

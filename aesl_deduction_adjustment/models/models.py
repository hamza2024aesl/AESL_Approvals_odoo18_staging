...
class hr_contract_inherited(models.Model):
    ...
    def process_deductions(self):
        ...
        for emp_reg in contracts:
            # Fetch the deduction data for the current date and employee number
            ...
            if deduction_data:
                # Prepare the deduction amounts to update
                ...
                # Iterate through existing deduction lines and update them
